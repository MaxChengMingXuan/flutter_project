...
//for pagination
  ...
  _showDetails(int index) async {
    ...
    loadSingleHost(index);
    //todo update Host object with empty object.
    ProgressDialog progressDialog = ProgressDialog(
      context,
      blur: 5,
      message: const Text("Loading..."),
  ...
  loadSingleHost(int index) {
    http.post(Uri.parse("${ServerConfig.SERVER}/php/load_host.php"),
        body: {"hostid": homestayList[index].userId}).then((response) {
      print(response.body);
      var jsonResponse = json.decode(response.body);
      if (response.statusCode == 200 && jsonResponse['status'] == "success") {
        host = User.fromJson(jsonResponse['data']);
      }
    });
  }
}
