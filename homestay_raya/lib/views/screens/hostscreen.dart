...
class _HostScreenState extends State<HostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(title: const Text("Host"), actions: [
            // IconButton(
              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Your current products/services (${homestayList.length} found)",
                        style: const TextStyle(
      ...
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == 'success') {
          ...
          if (extractdata['homestays'] != null) {
            ...
            titlecenter =
                "No Homestay Available Now"; //if no data returned show title center
            homestayList.clear();
          }
        } else {
          titlecenter = "No Connection";
        }
      } else {
        titlecenter =
            "No Homestay Available due to no connection"; //status code other than 200
